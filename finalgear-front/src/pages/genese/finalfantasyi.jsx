    ...
    <Page>
      <div className="flex justify-center">
        <h1 className="font-bold italic mb-3">
          FINAL FANTASY I
          <ImageComponent className="w-24 item-center" src="/FFlogos/FF1.png" />
        </h1>
      </div>
      ...
      <div>
        ...
        <table className="w-full text-left m-1">
          <thead>
            <tr>
              <td>Guerrier de la Lumière</td>
              <td className="flex justify-start gap-3">
                <ImageComponent
                  className="w-12"
                  src="/FFRKSprite/FF1/wol.png"
                />
              </td>
              <td>
                <p>
          ...
          <thead>
            <tr>
              ...
              <td className="flex justify-start gap-3">
                <ImageComponent
                  className="w-12"
                  src="/FFRKSprite/FF1/Garland.png"
                />
              </td>
              <td>
                <p>
